...
extension HomeVC_: ScrollProtocol {
  ...
  func setupScrollView() {
    ...
    card1 = CardPrimaryTitleLabel(card: card1)
    card1 = CardTaglineLabel(card: card1)
    var x = card1.build(scrollView: scrollView, previous: nil)

    NSLayoutConstraint.activate([
      (x!).theView!.topAnchor.constraint(equalTo: scrollView.topAnchor, constant: 20),
    ...
    var previousView = (card1).theView

    var card2: CardProtocol = Card()
    card2 = CardPrimaryTitleLabel(card: card2)
    card2 = CardTaglineLabel(card: card2)
    x = card2.build(scrollView: scrollView, previous: previousView)

    NSLayoutConstraint.activate([
      (x!).theView!.topAnchor.constraint(equalTo: (previousView?.bottomAnchor)!, constant: 20),
      (x!).theView!.centerXAnchor.constraint(equalTo: scrollView.centerXAnchor),
    ...
    card3 = CardPrimaryTitleLabel(card: card3)
    card3 = CardTaglineLabel(card: card3)
    card3 = CardActionableItem(card: card3, text: "Hello World", imageName: "clock")
    card3 = CardActionableItem(card: card3, text: "Heal the World", imageName: "calendar")
    ...
    card4 = CardPrimaryTitleLabel(card: card4)
